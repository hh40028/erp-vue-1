!function (a, b, c, d) {
    ...
    f.settings = {
        ...
        onhoverColor: "#eee",
        selectedColor: "#000",
        selectedBackColor: "rgba(0,0,0,0.1)",
        ...
        onSearchComplete: d,
        onSearchCleared: d
    }, f.options = {silent: !1, ignoreChildren: !1}, f.searchOptions = {ignoreCase: !0, exactMatch: !1, revealResults: !0};
    var g = function (b, c) {
    ...
    g.prototype.init = function (b) {
        ...
        var c = this.findNodes("true", "g", "state.selected");
        this.forEachIdentifier(c, b, a.proxy(function (a, b) {
            this.setSelectedState(a, !1, b)
        }, this)), this.render()
