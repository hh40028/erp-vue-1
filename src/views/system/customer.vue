                ...
                <div class="panel panel-default m-b-0">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <th class="text-center">收款账期(天)</th>
                        </tr>
                        </thead>
                        <tbody>
                        ...
                        <tr v-for="(o) in list" :key="o.id" @click="selectObj(o)" :class="{'bg-success':o.id===obj.id}">
                            ...
                            <td class="text-center">{{o.receivedays|number0}}</td>
                        </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>收款账期</label>
                            <input type="number" v-model="obj.receivedays" class="form-control">
                        </div>
                    </div>
...
export default {
    ...
    methods: {
        ...
        save(){
            ...
            this.$root.getData("customer/save", this.obj, function (data) {
