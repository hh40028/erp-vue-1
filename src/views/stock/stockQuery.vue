    ...
    data() {
        return {
            ...
            columns: [
                ...
                {field: 'norm', title: '规格', width: 90, titleAlign: 'center', columnAlign: 'center', isFrozen: false,isResize:true},
                {field: 'model', title: '型号', width: 90, titleAlign: 'center', columnAlign: 'center', isFrozen: false,isResize:true},
                {field: 'unit', title: '单位', width: 80, titleAlign: 'center', columnAlign: 'center', isFrozen: false,isResize:true},
                {field: 'stockprice', title: '库存均价', width: 150, titleAlign: 'center', columnAlign: 'right', isFrozen: false,isResize:true},
                {field: 'stockcount', title: '库存数量', width: 150, titleAlign: 'center', columnAlign: 'right', isFrozen: false,isResize:true},
                {field: 'amount', title: '合计', width: 150, titleAlign: 'center', columnAlign: 'right', isFrozen: false,isResize:true},
            ],
            list: [],
            filterString: '',
            obj: {}
