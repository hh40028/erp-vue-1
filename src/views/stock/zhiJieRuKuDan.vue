        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">直接入单列表</h3>
                </div>
                ...
                <table class="table table-bordered">
                    ...
                    <tr v-for="(obj,index) in list" :key="obj.id" @click="selectItem(obj)" @dblclick="view"
                        ...
                        <td class="text-center">{{ obj.entrydate }}</td>
                        <td class="text-center" :class="{'c-teal':obj.enterwarehouse}">{{ obj.enterwarehouse ? "已入库" : "未入库" }}</td>
                    </tr>
                    </tbody>
                </table>
            </div>
...
export default {
    ...
    methods: {
        ...
        view() {
            sessionStorage.directstorageObj = JSON.stringify(this.selectObj);
            this.$router.push('zhiJieRuKuDanMingXi');
        },
        add() {
            this.$router.push('zhiJieRuKuDanBianJi');
        }
    },
    watch: {
        filterString: {
