...
export default {
    ...
    data() {
        return {
            columns: [
                ...
                {field: 'number', title: '单据编号', width: 80, titleAlign: 'center', columnAlign: 'center', isFrozen: false,isResize:true},
                {field: 'contractno', title: '合同编号', width: 80, titleAlign: 'center', columnAlign: 'center', isFrozen: false,isResize:true},
                {field: 'customername', title: '客户', width: 80, titleAlign: 'center', columnAlign: 'center', isFrozen: false,isResize:true},
                {field: 'saleorderdate', title: '订货日期', width: 80, titleAlign: 'center', columnAlign: 'center', isFrozen: false,isResize:true},
                {field: 'total', title: '订货金额', width: 80, titleAlign: 'center', columnAlign: 'center', isFrozen: false,isResize:true},
                {field: 'enddate', title: '交付日期', width: 80, titleAlign: 'center', columnAlign: 'center', isFrozen: false,isResize:true},
                {field: 'userid', title: '录入人', width: 80, titleAlign: 'center', columnAlign: 'center', isFrozen: false,isResize:true},
            ],
            list: [],
            filterString: '',
            obj: {},
    ...
    methods: {
        ...
        add(){
            this.$router.push('SaleorderBanJi');
        },
        view(){
            sessionStorage.saleorderId=this.obj.id;
            this.$router.push('saleorderView');
        }
    },
    watch: {
        filterString: {
