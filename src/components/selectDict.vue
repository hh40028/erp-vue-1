<template>
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="modal fade" id="selectDictModal" tabindex="-1" role="dialog" aria-hidden="true">
...
export default {
    ...
    methods: {
        load: function () {
            let vm = this;
            this.$root.getData("api/getDictListByKey", {
                key: 'hetongleixing'
            }, function (data) {
                vm.list = [];
                var results = data;
                ...
                $('#selectDictModal').modal('show');
            })
        },
        selectItem(obj) {
            this.$emit('selectObj', obj);
            $('#selectDictModal').modal('hide');
        }
    },
    watch: {
        filterString: {
